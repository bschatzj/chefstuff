...
const ChefRecipe = props => {
  ...
  useEffect(() => {
    axios
      .get(
        `https://backend-chef.herokuapp.com/api/recipes/recipeId/${recipeid}`
      )
      .then(res => {
        setRecipe(res.data);
      })
  ...
  function remover() {
    axios
      .delete(
        `https://backend-chef.herokuapp.com/api/recipes/delete/${recipeid}`
      )
      .then(res => {
  ...
  const editer = e => {
    ...
    axios
      .put(
        `https://backend-chef.herokuapp.com/api/recipes/update/${recipeid}`,
        recipe
      )
      .then(res => {
        console.log(res.data);
